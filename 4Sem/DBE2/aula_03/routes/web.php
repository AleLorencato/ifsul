...
Route::delete('/carros/{id}/destroy', [CarroController::class, 'destroy'])->name('carro.destroy');
...
Route::delete('/users/{id}/destroy', [UsuarioController::class, 'destroy'])->name('user.destroy');
...
Route::delete('/motos/{id}/destroy', [MotoController::class, 'destroy'])->name('moto.destroy');
