...
public class Locacao {
    ...
    public Locacao(int id,LocalDateTime dataLocacao, LocalDateTime dataDevolucao,  int quilometragem, double valorCalcao, double valor_locacao, boolean devolvido) {
        this.id = id;
